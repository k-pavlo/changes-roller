...
class Repository:
    ...
    def clone(self) -> bool:
        ...
        try:
            ...
            raise RepositoryError(f"Failed to clone {self.url}: {e.stderr}")
    ...
    def setup_review(self) -> bool:
        ...
        try:
            ...
            raise RepositoryError(f"Failed to setup git-review: {e.stderr}")
    ...
    def has_changes(self) -> bool:
        ...
        try:
            ...
            raise RepositoryError(f"Failed to check status: {e.stderr}")
    ...
    def stage_all(self) -> bool:
        ...
        try:
            ...
            raise RepositoryError(f"Failed to stage changes: {e.stderr}")
    ...
    def commit(self, message: str) -> str:
        ...
        try:
            ...
            raise RepositoryError(f"Failed to commit: {e.stderr}")

    def submit_review(self, topic: Optional[str] = None) -> bool:
        ...
        try:
            ...
            raise RepositoryError(f"Failed to submit for review: {e.stderr}")
